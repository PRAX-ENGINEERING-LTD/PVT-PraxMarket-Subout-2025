...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h3><?php echo e($post->name ?? 'Post'); ?></h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e($post->name ?? 'Post'); ?></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-6 showPageTools" id="showPageTools">
                            <div class="action-btn postActionUpdate" id="postActionUpdate">
                                <a href="<?php echo e(route('posts.edit', $post->id)); ?>" class="bs-tooltip showToolTip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Delete">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <label class="showRowHead">Post Name</label>
                            <p class="adjustInputColor"><?php echo e($post->name); ?></p>
                        </div>

                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <label class="showRowHead">Post Description</label>
                            <p class="adjustInputColor"><?php echo e($post->description); ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <p class="adjustInputColor"><?php echo e($post->createdDate); ?></p>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <?php if($post->status == Config::get('constants.status.inActive')): ?>
                            <p class="adjustInputColor"><span class="badge badge-light-danger"><?php echo e(str_replace('_', ' ', $post->status ?? 'N/A')); ?></span></p>
                            <?php else: ?>
                            <p class="adjustInputColor"><span class="badge badge-light-success"><?php echo e(str_replace('_', ' ', $post->status ?? 'N/A')); ?></span></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <?php if($post->path): ?>
                            <img src="<?php echo e(Storage::disk('s3')->url($post->path)); ?>" alt="Uploaded Post" width="300">
...
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/posts/show.blade.php ENDPATH**/ ?>