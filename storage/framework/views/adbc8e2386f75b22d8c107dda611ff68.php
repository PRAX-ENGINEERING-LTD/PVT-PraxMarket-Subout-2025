            ...
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e($post->companyName); ?>
                        ...
                        <a data-confirm-route="<?php echo e(route('promotePost', ['postID' => $post->id, 'action' => 'PROMOTE'])); ?>" class="confirmModalAlert bs-tooltip myPostToolTip pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Promote Facebook Post" data-original-title="Promote Facebook Post">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-success feather feather-trending-up">
                        ...
                        <a data-confirm-route="<?php echo e(route('promotePost', ['postID' => $post->id, 'action' => 'PROMOTE'])); ?>" class="confirmModalAlert bs-tooltip myPostToolTip pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Promote Linkedin Post" data-original-title="Promote Linkedin Post">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-success feather feather-trending-up">
                                <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline>
                                <polyline points="17 6 23 6 23 12"></polyline>
                            </svg>
                        </a>
                        <a data-confirm-route="<?php echo e(route('promotePost', ['postID' => $post->id, 'action' => 'PROMOTE'])); ?>" class="confirmModalAlert bs-tooltip myPostToolTip pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Promote Instagram Post" data-original-title="Promote Instagram Post">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-success feather feather-trending-up">
                                <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline>
                                <polyline points="17 6 23 6 23 12"></polyline>
                            </svg>
                    ...
                    <div class="carousel slide" id="carouselExampleSlidesOnly" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active"><img class="d-block w-100"
                                    src="<?php echo e(isset($post->path) ? $post->path : ''); ?>" alt="drawing-room"></div>
...
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/posts/myPosts.blade.php ENDPATH**/ ?>