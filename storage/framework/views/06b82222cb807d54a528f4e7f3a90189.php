...
<script type="text/javascript">
    $(document).ready(function() {
        $("#tbdItems").on('click', '.viewAdvertisement', function() {
            ...
            window.location.href = "<?php echo e(url('my-advertisements')); ?>" + "/" + advertisementID;
        });
    });
</script>
                ...
                <div class="card-body pt-0 px-0">
                    <div class="list-product user-list-table">
                        <div class="table-responsive custom-scrollbar">
                            <table class="table" id="<?php echo e(count($advertisements) > 0 ? 'myadvertisement-index-tables' : ''); ?>">
                                ...
                                <tbody id="tbdItems">
                                    ...
                                    <tr class="pointer product-removes inbox-data" id="pageUpdateButtons1" advertisementID="<?php echo e($advertisement->id); ?>">
                                        ...
                                        <td class="advertisementActionUpdate" id="advertisementActionUpdate">
                                            <div class="common-align gap-2 justify-content-start">
                                               
                                               
                                                <a href="<?php echo e(route('advertisements.edit',$advertisement->id)); ?>" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Delete">
...
'containerID' => 'myadvertisement-index-tables',
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/advertisements/allAdvertisement.blade.php ENDPATH**/ ?>