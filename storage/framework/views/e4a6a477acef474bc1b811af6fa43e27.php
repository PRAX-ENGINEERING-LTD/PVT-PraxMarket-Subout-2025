...
<div class="page-header page-header-1">
    <div class="header-wrapper header-wrapper-1 row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="<?php echo e(route('network.index')); ?>"><img class="img-fluid for-light"
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="d-flex profile-media">
                        ...
                        <div class="avatar-circle">
                            <span class="avatar-text"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                        </div>
                        <div class="head-icon">
                            <span class="auth-name"><?php echo e(!empty(Auth::user()) ? ucfirst(substr(Auth::user()->name, 0, 8)) : null); ?></span>
                            <p class="mb-0"><?php echo e(str_replace('_', ' ', Auth::user()->role[0] ?? '')); ?>
                    ...
                    <ul class="profile-dropdown onhover-show-div profile-dropdown-1">
                        <li><a href="<?php echo e(route('profile.showMyAccountPage')); ?>"><i data-feather="user"></i><span>My Account </span></a></li>
                        ...
                        <li class="sidebar-list d-none"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title">
                            ...
                            <ul class="sidebar-submenu">
                                <li><a href="<?php echo e(route('dataForPremiumProfile')); ?>">My Premium Profile</a></li>
                                <li><a href="<?php echo e(route('profile.basicDetails')); ?>">Profile Contents</a></li>
                                <li><a href="<?php echo e(route('companyUsers.index')); ?>">Company Users</a></li>
                                <li><a href="<?php echo e(route('companyMachines.index')); ?>">Company Machines</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><img class="for-light" src="<?php echo e(asset('newAssets/img/premiumpage/Crown.png')); ?>" style="width:28px;height:25px;object-fit: cover;margin-right:10px" alt="Logo for light theme">Premium Profile – Unlock More Features with PRAX Market Premium</h5><button
            ...
            <div class="modal-body dark-modal">
                <div class="container content-cont">
                    <img class="for-light" src="<?php echo e(asset('newAssets/img/premiumpage/initalmodalp1.png')); ?>" style="width:270px;object-fit: cover;margin-right:10px" alt="Logo for light theme">
                    <div class="content">
                        <div class="section">
            ...
            <div class="modal-footer"> <button class="btn btn-secondary" type="button"
                    ...
                    type="button" href="<?php echo e(route('profile.basicDetails')); ?>">Proceed to edit</a></div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?php echo e(route('getPremiumProfileStatus')); ?>", // Replace with your actual Laravel route URL
            type: 'GET',
    ...
    $(document).ready(function () {
    $.ajax({
        url: "<?php echo e(route('profile.getSubscriptionStatus')); ?>",
        type: 'GET',
        success: function (response) {
...
</script><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/appLayouts/header.blade.php ENDPATH**/ ?>