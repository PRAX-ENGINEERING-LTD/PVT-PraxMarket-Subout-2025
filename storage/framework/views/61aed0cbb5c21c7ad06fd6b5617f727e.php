          ...
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="logo-container">
                <?php if(isset($premiumProfile->companyDetails->path)): ?>
                <img loading="lazy" src="<?php echo e(Storage::disk('s3')->url($premiumProfile->companyDetails->path)); ?>" alt="Company Avatar">
                <?php else: ?>
                <img loading="lazy" src="<?php echo e(asset('newAssets/img/premiumpage/Logo2.png')); ?>" alt="Default Avatar">
                <?php endif; ?>
              </div>
              ...
              <div class="action-buttons">
                <button class="btn me-2 btn-hero d-none">Chat with supplier</button>
                <button class="btn  btn-hero-2 d-none">Request Quote</button>
                <?php if($premiumProfile->companyDetails->id !== Auth::user()->id): ?>
                <button class="btn me-2 btn-hero" data-bs-toggle="modal" data-bs-target="#contactFormModal">Contact with supplier</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
...
<div class="container-fluid posts-container">
  <div class="row">
    ...
    <?php if(isset($premiumProfile->posts)): ?>
    <div class="col-lg-12 col-md-12">
      ...
      <div class="row">
        <!-- First Row of Posts -->
        <?php $__currentLoopData = $premiumProfile->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $posts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="post-card">
            <img loading="lazy" src="<?php echo e($posts->path); ?>" alt="Skyscrapers" class="post-image">
            <div class="post-content">
              <div class="post-date">Posted on <?php echo e($posts->postedOn ?? 'Posted on sample date'); ?></div>
              <div class="post-title"><?php echo e($posts->description ?? 'sample description of the post.'); ?></div>
              <div class="post-interactions">
                <div class="interaction">
                  <i class="far fa-heart"></i> <?php echo e($posts->totalLikes ?? '0'); ?>

                </div>
                <div class="interaction">
                  <i class="far fa-comment"></i> <?php echo e($posts->totalComments ?? '0'); ?>
    ...
    <div class="col-md-7">
      <!-- Posts Section Title -->
      <h4 class="section-title">Sample Posts</h4>

      <!-- Post Grid -->
      <div class="row">
        <!-- First Row of Posts -->
        <div class="col-md-4 mb-4">
          <div class="post-card" style="margin-bottom: 0px;">
            <img loading="lazy" src="<?php echo e(asset('newAssets/img/premiumpage/social/1.jpg')); ?>" alt="Skyscrapers" class="post-image">
            <div class="post-content">
        ...
        <div class="col-md-4 mb-4">
          <div class="post-card" style="margin-bottom: 0px;">
            <img loading="lazy" src="<?php echo e(asset('newAssets/img/premiumpage/2.png')); ?>" alt="Payment Device" class="post-image">
            <div class="post-content">
              <div class="post-date">Posted on March 19, 2025</div>
              <div class="post-title">Complete machining of complex parts thanks to Y-axis.</div>
              <div class="post-interactions">
        ...
        <div class="col-md-4 mb-4">
          <div class="post-card" style="margin-bottom: 0px;">
            <img loading="lazy" src="<?php echo e(asset('newAssets/img/premiumpage/3.png')); ?>" alt="Computer Screen" class="post-image">
            <div class="post-content">
              <div class="post-date">Posted on March 19, 2025</div>
              <div class="post-title">Complete machining of complex parts thanks to Y-axis.</div>
              <div class="post-interactions">
...
<div class="toast-container position-fixed top-0 end-0 p-3">
  <div id="contactFormToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="contactFormModalLabel">Contact with Supplier</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form class="text-left needs-validation customForm" role="form" method="POST" id="frmCreateCompany" data-company-id="<?php echo e($premiumProfile->companyID); ?>">
...
<style>
  .modal-backdrop {
    ...
    /* Adjust opacity (0.3 is lighter, 0.7 is darker) */
  }
</style>
...
<script>
 $(document).ready(function() {
  console.log('Document ready, jQuery loaded'); // Debug: Confirm script is running
  ...
  $('.submitContactForm').on('click', function(e) {
    ...
    const form = $('#frmCreateCompany');
    const message = $('#message').val().trim();
    const companyID = form.data('company-id') || <?php echo json_encode($premiumProfile->companyID); ?>;
    const csrfToken = form.find('input[name="_token"]').val();
    const authID = "<?php echo e(Auth::user()->id); ?>";
    console.log('Form data:', { authID, companyID, message, csrfToken }); // Debug
    ...
    // AJAX POST request
    $.ajax({
      url: '<?php echo e(route("makeContactWithSupplier")); ?>',
      type: 'POST',
      data: params,
      headers: {
      ...
      success: function(response) {
        ...
        showToast(true, 'Successfully sent');
        closeModal();
        form[0].reset();
  ...
  function closeModal() {
    ...
    modal.modal('hide');
    // Ensure backdrop and modal-open class are removed after animation
    setTimeout(() => {
      $('body').removeClass('modal-open').css('overflow', '');
      $('.modal-backdrop').remove();
    }, 500); // Match Bootstrap modal transition duration
  }

  // Function to show Bootstrap toast
  function showToast(success, message) {
    console.log('Attempting to show toast:', { success, message });
    const toastEl = $('#contactFormToast');
    if (!toastEl.length) {
      console.error('Toast element #contactFormToast not found in DOM');
      alert(success ? 'Successfully sent' : message); // Fallback to alert
      return;
    }
    ...
    toastEl.addClass(success ? 'bg-success text-white' : 'bg-danger text-white');
...
<?php echo $__env->make('appLayouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/companies/companyPremiumPage.blade.php ENDPATH**/ ?>