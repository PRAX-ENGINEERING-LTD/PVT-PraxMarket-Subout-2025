...
<head>
    ...
    <style>
        .card-bg {
            background-image: url("<?php echo e(asset('newAssets/img/homecomponents/Services/bg3.png')); ?>");
        ...
        .feature-card {
            background-image: url("<?php echo e(asset('newAssets/img/homecomponents/Services/bg2.png')); ?>");
            border-radius: 16px;
            color: white;
            padding: 20px;
        ...
        <div class="container">
            ...
            <div class="text-center find-provide">
                <button class="btn-service-one-new" style="font-family: 'Manrope-Medium';">
                    <img src="<?php echo e(asset('newAssets/img/homecomponents/Services/Icons/user.png')); ?>" style="margin-right: 10px; margin-top: -3px; width:16px">Find Providers
                </button>
            </div>
            ...
            <div class="row g-4  fetured-new-pb">
                <div class="col-md-4">
                    <div class="feature-card">
                        <div class="icon-container">
                            <img src="<?php echo e(asset('newAssets/img/homecomponents/Services/Icons/1.png')); ?>" alt="" class="icon-service" />
                        </div>
                ...
                <div class="col-md-4">
                    <div class="feature-card">
                        <div class="icon-container">
                            <img src="<?php echo e(asset('newAssets/img/homecomponents/Services/Icons/3.png')); ?>" alt="" class="icon-service" />
                        </div>
                ...
                <div class="col-md-4">
                    <div class="feature-card">
                        <div class="icon-container">
                            <img src="<?php echo e(asset('newAssets/img/homecomponents/Services/Icons/2.png')); ?>" alt="" class="icon-service" />
                        </div>
...
</html><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/staticPages/home/homeComponents/cardsection.blade.php ENDPATH**/ ?>