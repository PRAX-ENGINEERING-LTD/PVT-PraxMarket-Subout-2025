                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 showPageTools" id="showPageTools">
                            <div class="action-btn companyActionUpdate" id="companyActionUpdate">
                                <a href="<?php echo e(route('companies.edit', $company->id)); ?>" class="bs-tooltip showToolTip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Delete">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <p class="adjustInputColor"><?php echo e($company->companyEmail ?? 'Customer Email'); ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <p class="adjustInputColor"><?php echo e($company->determineCountryName($company->countryID)); ?></p>
                        </div>

                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <label class="showRowHead">Subscription Type</label>
                            <p class="adjustInputColor"><?php echo e($company->determineSubscriptionName($company->subscriptionID)); ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <p class="adjustInputColor"><?php echo e($company->getUserID['name'] ?? 'N/A'); ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <p class="adjustInputColor"><?php echo e($company->getUpdatedUserID['name'] ?? 'N/A'); ?></p>
                        </div>

                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <label class="showRowHead">Status</label>
                            <?php if($company->status == Config::get('constants.status.inActive')): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 mb-3">
                            ...
                            <script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('constants.websiteConfigurations.googleApiKey')); ?>&callback=initMap" type="text/javascript"></script>
...
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/companies/approveCompanyShow.blade.php ENDPATH**/ ?>