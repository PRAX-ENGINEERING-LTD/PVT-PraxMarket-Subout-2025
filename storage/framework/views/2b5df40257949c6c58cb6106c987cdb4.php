        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">My Progress Jobs</li>
                </ol>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/jobs/mySupplier/myprogressjobs.blade.php ENDPATH**/ ?>