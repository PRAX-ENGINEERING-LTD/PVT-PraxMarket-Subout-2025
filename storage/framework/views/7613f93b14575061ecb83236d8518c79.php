...
<head>
    ...
    -webkit-text-fill-color: transparent;
        ...
        .card-advantage {
            ...
            background-image: url("<?php echo e(asset('newAssets/img/home/advantage.png')); ?>");
            background-size: cover;
            background-position: bottom;
            background-repeat: no-repeat;
            border-radius: 23px;
...
<body>
    ...
    <div id="particles-advantage"></div>
        <div class="testimonials-btn-advan">
            <img src="<?php echo e(asset('newAssets/img/homecomponents/advantage/star.png')); ?>" loading="lazy" style="width: 16px;margin-top: -2px;"><span style="font-family: 'Manrope-Medium';" class="testi">Advantage</span></img>
        </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4">
                    <div class="text-center">
                        <img src="<?php echo e(asset('newAssets/img/homecomponents/advantage/1.png')); ?>" loading="lazy" alt="Seamless Collaboration" class="img-advantage" />
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="text-center">
                        <img src="<?php echo e(asset('newAssets/img/homecomponents/advantage/2.png')); ?>" loading="lazy" alt="Industry Solutions" class="img-advantage" />
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="text-center">
                        <img src="<?php echo e(asset('newAssets/img/homecomponents/advantage/3.png')); ?>" loading="lazy" alt="Market Insight" class="img-advantage" />
...
</html><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/staticPages/home/homeComponents/advantage.blade.php ENDPATH**/ ?>