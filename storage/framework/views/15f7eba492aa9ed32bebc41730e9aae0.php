...
<head>
    ...
    <style>
        ...
        .head-1-smart {
            background-image: url("<?php echo e(asset('newAssets/img/homecomponents/competitiveedge/1.png')); ?>");
        ...
        .head-2-smart {
            background-image: url("<?php echo e(asset('newAssets/img/homecomponents/competitiveedge/2.png')); ?>");
            background-size: cover;
            background-position: center;
            height: 136px;
            background-repeat: no-repeat;
        ...
        .head-3-smart {
            background-image: url("<?php echo e(asset('newAssets/img/homecomponents/competitiveedge/3.png')); ?>");
            background-size: cover;
            height: 136px;
            background-position: center;
            background-repeat: no-repeat;
        ...
        .head-4-smart {
            background-image: url("<?php echo e(asset('newAssets/img/homecomponents/competitiveedge/4.png')); ?>");
            background-size: cover;
            background-position: center;
            height: 136px;
            background-repeat: no-repeat;
        ...
        .head-5-smart {
            background-image: url("<?php echo e(asset('newAssets/img/homecomponents/competitiveedge/5.png')); ?>");
            background-size: cover;
            background-position: center;
            height: 136px;
            background-repeat: no-repeat;
...
<body>
    <div class="container-fluid competive-main mt-5">
        ...
        <div class="testimonials-btn2-competive">
            <span class="testi"> <img src="<?php echo e(asset('newAssets/img/homecomponents/competitiveedge/6.png')); ?>" loading="lazy" style="width: 16px;margin-top: -2px;"> <span style="margin-left: 5px;">Competitive Advantage</span></span>
        </div>
...
</html><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/staticPages/home/homeComponents/competitiveEdge.blade.php ENDPATH**/ ?>