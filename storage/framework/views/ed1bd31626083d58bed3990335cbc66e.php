 <!-- latest jquery-->
    ...
    <script src="<?php echo e(asset('assets/js/script1.js')); ?>"></script><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/appLayouts/comingsoon_layouts/scripts.blade.php ENDPATH**/ ?>