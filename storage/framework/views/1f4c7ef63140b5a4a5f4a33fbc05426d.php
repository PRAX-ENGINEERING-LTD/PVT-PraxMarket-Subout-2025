...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-7"><img class="bg-img-cover bg-center" src="<?php echo e(asset('newAssets/img/login/2.jpg')); ?>"
                alt="looginpage"></div>
        <div class="col-xl-5 p-0">
            <div class="login-card login-dark">
                <div>
                    <div><a class="logo text-start" href="<?php echo e(url('/home.showHomePage')); ?>"><img class="img-fluid for-light"
                        ...
                        <form class="theme-form">
                            ...
                            <div class="form-group mb-0">
                                <div class="form-check form-new-check">
                                    ...
                                    <label class=""><a class="" href="<?php echo e(url('/forgetpassword')); ?>">Forgot Password?</a></label>
                                </div>
                            ...
                            <p class="mt-4 mb-0 text-center">Don't have account?<a class="ms-2"
                                    href="<?php echo e(url('/signup')); ?>">Create Account</a></p>
                        </form>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('appLayouts.authentication.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/authentication/login.blade.php ENDPATH**/ ?>