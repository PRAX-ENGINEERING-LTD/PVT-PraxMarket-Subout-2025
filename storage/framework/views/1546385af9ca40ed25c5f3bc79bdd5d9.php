...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h3><?php echo e($companyMachine->machineName ?? 'Company Machine'); ?></h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="decolorAnchorTag" href="<?php echo e(route('companyMachines.index')); ?>">Company Machines</a></li>

                    <li class="breadcrumb-item active"><?php echo e($companyMachine->machineName ?? 'Company Machine'); ?></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    ...
    <?php if(session('companyMachine_stored')): ?>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-6 showPageTools" id="showPageTools">
                            <div class="action-btn companyMachineActionUpdate" id="companyMachineActionUpdate">
                                <a href="<?php echo e(route('companyMachines.edit', $companyMachine->id)); ?>" class="bs-tooltip showToolTip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Delete">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <label class="showRowHead">Machine Name</label>
                            <p class="adjustInputColor"><?php echo e($companyMachine->machineName); ?></p>
                        </div>

                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <label class="showRowHead">Machine Description</label>
                            <p class="adjustInputColor"><?php echo e($companyMachine->description); ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <p class="adjustInputColor"><?php echo e($companyMachine->createdDate); ?></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <img src="<?php echo e(isset($companyMachine->path) ? $companyMachine->path : ''); ?>" alt="Uploaded Photo" width="300">
...
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/companyMachines/show.blade.php ENDPATH**/ ?>