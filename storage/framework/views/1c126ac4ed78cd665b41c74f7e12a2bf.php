        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">My RFQS</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header card-no-border text-end">
                    <div class="card-header-right-icon"><a class="btn btn-primary f-w-500"
                            href="<?php echo e(route('jobs.viewMyRfqs')); ?>"><i class="fa-solid fa-plus pe-2"></i>Refresh</a></div>
                </div>
...
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/jobs/myCustomer/myRfqs.blade.php ENDPATH**/ ?>