...
<script type="text/javascript">
    $(document).ready(function() {
        $("#tbdItems").on('click', '.viewSubscription', function() {
            var subscriptionID = $(this).closest('tr').attr("subscriptionID");
            window.location.href = "<?php echo e(route('subscriptions.index')); ?>/" + subscriptionID;
        });
        $(".deleteUser").click(function() {
            ...
            $("#frmDeleteModel").attr("action", "<?php echo e(route('subscriptions.index')); ?>/" + subscriptionID);
        });
    });
</script>
<style>
            ...
            <div class="card">
                <div class="card-header card-no-border text-end">
                    <div class="card-header-right-icon"><a class="btn btn-primary f-w-500"
                            href="<?php echo e(route('subscriptions.create')); ?>"><i class="fa-solid fa-plus pe-2"></i>Add Subscription</a></div>
                </div>
                <div class="card-body pt-0 px-0">
                    <div class="list-product user-list-table">
                        <div class="table-responsive custom-scrollbar">
                            <table class="table" id="<?php echo e(count($subscriptions) > 0 ? 'subscription-index-tables' : ''); ?>">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="tbdItems">
                                    ...
                                    <tr class="pointer product-removes inbox-data" id="pageUpdateButtons1" subscriptionID="<?php echo e($subscription->id); ?>">
                                        <td class="viewSubscription">
                                            <p> <?php echo e($subscription->name  ?? 'N/A'); ?> </p>
                                        </td>

                                        <td class="viewSubscription">
                                            <p> <?php echo e($subscription->amount  ?? 'N/A'); ?> </p>
                                        </td>

                                        <td class="viewSubscription">
                                            <p> <?php echo e($subscription->duration  ?? 'N/A'); ?> </p>
                                        </td>

                                        <td class="viewSubscription">
                                            <p> <?php echo e($subscription->packageDiscount  ?? 'N/A'); ?> </p>
                                        </td>

                                        <?php if($subscription->status == 'INACTIVE'): ?>
                                        <td class="viewSubscription"><span class="badge badge-light-danger"><?php echo e(str_replace('_', ' ', $subscription->status ?? 'N/A')); ?></span></td>
                                        <?php else: ?>
                                        <td class="viewSubscription"><span class="badge badge-light-success"><?php echo e(str_replace('_', ' ', $subscription->status ?? 'N/A')); ?></span></td>
                                        <?php endif; ?>


                                        <td class="viewSubscription">
                                            <p><?php echo e($subscription->updated_at ?? 'N/A'); ?></p>
                                        </td>
                                        <td class="subscriptionActionUpdate" id="subscriptionActionUpdate">
                                            <div class="common-align gap-2 justify-content-start">
                                                <a href="<?php echo e(route('subscriptions.edit', $subscription->id)); ?>" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Delete">
...
'containerID' => 'subscription-index-tables',
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/subscriptions/index.blade.php ENDPATH**/ ?>