...
<script type="text/javascript">
    $(document).ready(function() {
        $("#tbdItems").on('click', '.viewCatagory', function() {
            var catagoryID = $(this).closest('tr').attr("catagoryID");
            window.location.href = "<?php echo e(route('catagories.index')); ?>/" + catagoryID;
        });
        $(".deleteCatagory").click(function() {
            ...
            $("#frmDeleteModel").attr("action", "<?php echo e(route('catagories.index')); ?>/" + catagoryID);
        });
        $(".viewCatagoryInPopup").on("click", function() {
            var catagoryUrl = $(this).attr("catagoryUrl");
            $("#photoAsset").attr("src", catagoryUrl);
        });
            ...
            <div class="card">
                <div class="card-header card-no-border text-end">
                    <div class="card-header-right-icon"><a class="btn btn-primary f-w-500"
                            href="<?php echo e(route('catagories.create')); ?>"><i class="fa-solid fa-plus pe-2"></i>Add Catagory</a></div>
                </div>
                <div class="card-body pt-0 px-0">
                    <div class="list-product user-list-table">
                        <div class="table-responsive custom-scrollbar">
                            <table class="table" id="<?php echo e(count($catagories) > 0 ? 'catagory-index-tables' : ''); ?>">

                                <thead>
                                    <tr>
                                        <th> <span class="c-o-light f-w-600">Name</span></th>
                                        <th> <span class="c-o-light f-w-600">Catagory Image</span></th>
                                ...
                                <tbody id="tbdItems">
                                    ...
                                    <tr class="pointer product-removes inbox-data" id="pageUpdateButtons1" catagoryID="<?php echo e($catagory->id); ?>">
                                        <td class="viewCatagory"> <?php echo e($catagory->name  ?? 'N/A'); ?></td>

                                        <td class="viewCatagory">
                                            <img src="<?php echo e(isset($catagory->path) ? Storage::disk('s3')->url($catagory->path) : ''); ?>" alt="Uploaded Catagory" width="100" height="100" loading="lazy">
                                        </td>
                                        <?php if($catagory->status == 'INACTIVE'): ?>
                                        <td class="viewCatagory"><span class="badge badge-light-danger"><?php echo e(str_replace('_', ' ', $catagory->status ?? 'N/A')); ?></span></td>
                                        <?php else: ?>
                                        <td class="viewCatagory"><span class="badge badge-light-primary"><?php echo e(str_replace('_', ' ', $catagory->status ?? 'N/A')); ?></span></td>
                                        <?php endif; ?>

                                        <td class="viewCatagory"> <?php echo e($catagory->getUserID['name'] ?? 'N/A'); ?></td>



                                        <td class="viewCatagory">
                                            <p><?php echo e($catagory->updated_at); ?></p>
                                        </td>
                                        <td class="catagoryActionUpdate" id="catagoryActionUpdate">
                                            <div class="common-align gap-2 justify-content-start">
                                                <a class="bs-tooltip pointer viewCatagoryInPopup" catagoryUrl="<?php echo e(isset($catagory->path) ? Storage::disk('s3')->url($catagory->path) : ''); ?>" data-toggle="modal" data-bs-target="#verticalModal" aria-hidden="true" data-bs-toggle="modal" data-bs-placement="top"> <svg class="text-primary feather feather-eye me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="View Catagory" data-original-title="View Catagory" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                                        <circle cx="12" cy="12" r="3"></circle>
                                                    </svg> </a>
                                                <a href="<?php echo e(route('catagories.edit', $catagory->id)); ?>" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Delete">
...
'containerID' => 'catagory-index-tables',
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/catagories/index.blade.php ENDPATH**/ ?>