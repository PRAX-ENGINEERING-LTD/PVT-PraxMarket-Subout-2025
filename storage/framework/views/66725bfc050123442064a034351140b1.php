...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h3><?php echo e($slider->sliderName ?? 'Slider'); ?></h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="decolorAnchorTag" href="<?php echo e(route('sliders.index')); ?>">Sliders</a></li>

                    <li class="breadcrumb-item active"><?php echo e($slider->sliderName ?? 'Slider'); ?></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-6 showPageTools" id="showPageTools">
                            <div class="action-btn sliderActionUpdate" id="sliderActionUpdate">
                                <a href="<?php echo e(route('sliders.edit', $slider->id)); ?>" class="bs-tooltip showToolTip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Delete">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <label class="showRowHead">Slider Name</label>
                            <p class="adjustInputColor"><?php echo e($slider->sliderName); ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <p class="adjustInputColor"><?php echo e($slider->createdDate); ?></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            ...
                            <img src="<?php echo e(isset($slider->path) ? $slider->path : ''); ?>" alt="Uploaded Photo" width="300">
...
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/sliders/show.blade.php ENDPATH**/ ?>