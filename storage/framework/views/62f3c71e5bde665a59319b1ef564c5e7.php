...
<head>
    ...
    padding-right: 64px;
        ...
        .about-section-one {
            background-image: url("<?php echo e(asset('newAssets/img/about/bg2.png')); ?>");
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            padding: 80px;
...
<body>
    <div class="container-fluid about-section">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-img">
                <img src="<?php echo e(asset('newAssets/img/about/1.jpg')); ?>" alt=""  loading="lazy" class="about-hero-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-1 order-md-1">
            <div class="about-img">
                <img src="<?php echo e(asset('newAssets/img/about/vision.png')); ?>" loading="lazy" alt="Laptop on concrete blocks" class="img-fluid w-100">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid about-mission">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <img src="<?php echo e(asset('newAssets/img/about/Mission.png')); ?>"  loading="lazy" alt="" style="width: 100%;object-fit:cover">
            </div>
        </div>
    </div>
    ...
    <section>
        <div class="container-fluid about-section-one mt-5 pe-lg-4">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="about-img"> 
                        <img src="<?php echo e(asset('newAssets/img/about/2.png')); ?>"  loading="lazy" alt="Laptop on concrete blocks" class="story-img img-fluid w-100">
                    </div>
                </div>
    ...
    <section class="about-philosophy-bg">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <!-- Right column with visualization -->
                <div class="col-md-6">
                    <img src="<?php echo e(asset('newAssets/img/about/our1.png')); ?>"  loading="lazy" alt="" style="width: 100%; object-fit: cover;">
                </div>
            </div>
        </div>
    </section>
...
</html><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/staticPages/aboutus/aboutComponents/about.blade.php ENDPATH**/ ?>