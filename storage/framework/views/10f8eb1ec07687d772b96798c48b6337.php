...
<style>
    ...
    .company-card-dashboard {
        position: relative;
        z-index: 1;
        /* Base stacking context for the card */
        overflow: visible !important;
        /* Prevent clipping */
        transform: none !important;
        /* Avoid creating a new stacking context */
        opacity: 1 !important;
        /* Avoid stacking context from opacity */
    ...
    .company-name-dashboard {
        ...
        min-height: 30px;
        /* Match image height to avoid shifting */
    }
    ...
    .company-name-dashboard-map:hover::after {
        top: -23px !important
    }
    ...
    .viewCompany {
        isolation: isolate;
        /* Create a new stacking context to isolate children */
    }
    ...
    <div class="controls-dashboard">
        <div class="view-controls-dashboard">
            <a href="#" id="mapIcon" data-tooltip="Map View">
                ...
                <img src="<?php echo e(asset('newAssets/img/dashboard/map.png')); ?>" class="trigger-icon icon-bg" style="    width: 100%;
    object-fit: cover;
    height: 100%;" />
            </a>
            <a href="#" id="gridIcon" data-tooltip="Grid View" style="display: none;">
                <!-- <i class="fa-solid fa-border-all icon-bg"></i> -->
                <img src="<?php echo e(asset('newAssets/img/dashboard/grid.png')); ?>" class="icon-bg" style="    width: 100%;
    object-fit: cover;
    height: 100%;" />
            </a>
            <button class="filter-btn" id="filterBtn">
                <img src="<?php echo e(asset('newAssets/img/dashboard/filter.png')); ?>" style="width:16px" />Filter
            </button>
        </div>
    </div>
</div>
        ...
        <div class="col" style="display: none;">
            <!-- <div class="service-card">
                <div class="service-icon">`
                    <img src="<?php echo e(asset('newAssets/img/dashboard/icons/1.png')); ?>" alt="CNC Machining">
                </div>
...
<div class="header-dashboard">
    <div class="dropdown-wrapper-dash">
        ...
        object-fit: cover;margin-left: -23px;" src="<?php echo e(asset('newAssets/img/dashboard/icons/13.png')); ?>" alt="CNC Machining" class="dropdown-arrow-dash">
        <!-- <div class="dropdown-arrow-dash"></div> -->
    </div>

    <div class="search-wrapper-dash">
        <div class="search-icon-dash">
            <img style="width: 20px;object-fit: cover;" src="<?php echo e(asset('newAssets/img/dashboard/icons/search.png')); ?>" alt="CNC Machining">
        </div>
...
<div class="container-fluid">
    ...
    <?php echo $__env->make('appLayouts.addedLayouts._alert', array('alertType' => 'success', 'message' => session('job_deleted')), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif(session('job_stored')): ?>
    <?php echo $__env->make('appLayouts.addedLayouts._alert', array('alertType' => 'success', 'message' => session('job_stored')), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif(session('job_updated')): ?>
    <?php echo $__env->make('appLayouts.addedLayouts._alert', array('alertType' => 'success', 'message' => session('job_updated')), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
        ...
        <div class="col-xl-3 location-view" id="locations-container" style="display: none;">
            <div class="card search-panel">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <h5 class="mb-0 find-t"> <img src="<?php echo e(asset('newAssets/img/dashboard/8.png')); ?>" style="width:20px;margin-right: 5px;margin-top: -3px;" />Find a location near you</h5>
                </div>
                <div class="card-body">
...
<div class="filter-card" id="filterCard">
    <div class="filter-header">
        <h2>Filters</h2>
        <button style="font-size: 12px;" style="border:none" class="btn-close" id="closeFilter"></button>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const queryParams = <?php echo json_encode(isset($queryParams) ? $queryParams : [], 15, 512) ?>;
            ...
            filterTags.forEach(tag => {
                ...
                newTag.addEventListener('click', function(e) {
                    ...
                    if (type === 'distance') {
                        ...
                        // Handle single-select for category
                        document.querySelectorAll('.filter-tag[data-type="category"]').forEach(categoryTag => {
                            if (categoryTag !== this) {
                                categoryTag.classList.remove('active');
                                const categoryIcon = categoryTag.querySelector('i');
                                categoryIcon.classList.remove('fa-check');
                                categoryIcon.classList.add('fa-plus');
                                selectedSubcatIds.delete(categoryTag.getAttribute('data-value'));
                                const subcatCard = document.querySelector(`.viewSubcategory[data-subcatid="${categoryTag.getAttribute('data-value')}"]`);
                                if (subcatCard) {
                        ...
                        // Toggle the clicked category filter
                        if (this.classList.contains('active')) {
                            this.classList.remove('active');
                            icon.classList.remove('fa-check');
                            icon.classList.add('fa-plus');
                        ...
                        // Handle single-select for availability
                        document.querySelectorAll('.filter-tag[data-type="availability"]').forEach(availTag => {
                            if (availTag !== this) {
                                availTag.classList.remove('active');
                                const availIcon = availTag.querySelector('i');
                                availIcon.classList.remove('fa-check');
                                availIcon.classList.add('fa-plus');
                                activeFilters.delete(availTag.getAttribute('data-value'));
                                const headerClass = ({
                                    'IMMEDIATE': 'available-dashboard',
                                    'WEEKS': 'weeks-dashboard',
                                    'MONTHS': 'months-dashboard'
                                })[availTag.getAttribute('data-value')] || availTag.getAttribute('data-value').toLowerCase() + '-dashboard';
                        ...
                        // Toggle the clicked availability filter
                        if (this.classList.contains('active')) {
                            this.classList.remove('active');
                            icon.classList.remove('fa-check');
                            icon.classList.add('fa-plus');
                        ...
                        // Handle single-select for rating
                        document.querySelectorAll('.filter-tag[data-type="rating"]').forEach(ratingTag => {
                            if (ratingTag !== this) {
                                ratingTag.classList.remove('active');
                                const ratingIcon = ratingTag.querySelector('i');
                                ratingIcon.classList.remove('fa-check');
                                ratingIcon.classList.add('fa-star');
                                selectedRatings.delete(ratingTag.getAttribute('data-value'));
                            }
                        });

                        // Toggle the clicked rating filter
                        if (this.classList.contains('active')) {
                            this.classList.remove('active');
                            icon.classList.remove('fa-check');
    ...
    `;
        ...
        `;
            ...
            validLocations.forEach((location, index) => {
                ...
                const imgSrc = location.imgassets || '<?php echo e(asset("newAssets/img/dashboard/12.avif")); ?>';
            ...
            <div class="supplier-card-map p-3 h-100 location-item"
                ...
                <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <h5 class="mb-0 map-km">
                        <img src="<?php echo e(asset('newAssets/img/dashboard/6.png')); ?>" style="width:16px;margin-right: 2px;"/>
                ...
                <h5 class="mb-2" style="font-size: 16px; font-family: 'Manrope-Bold';">
                    <div class="dp-img">
                        <div class="company-name-dashboard company-name-dashboard-map" data-tooltip="${location.name}">  <span class="company-name-text">${truncateName(location.name)}</span></div>
                    </div>
                </h5>
                <div class="mb-2">
                ...
                <div class="supplier-contact-info mb-2">
                    <img src="<?php echo e(asset('newAssets/img/dashboard/mapicons/1.png')); ?>" style="width:16px"/><span style="margin-left: 4px;font-size: 14px;">${location.phone1 || location.contactNumber || '0044 79610087'}</span>
                </div>
                <div class="supplier-contact-info mb-2">
                    <img src="<?php echo e(asset('newAssets/img/dashboard/mapicons/2.png')); ?>" style="width:16px"/><span style="margin-left: 4px;font-size: 14px;">${location.phone2 || '0044 1480759133'}</span>
                </div>
                <div class="supplier-contact-info mb-2">
                    <img src="<?php echo e(asset('newAssets/img/dashboard/mapicons/3.png')); ?>" style="width:16px"/><span style="margin-left: 4px;width: 220px;font-size: 14px;">${location.email || 'info@praxmarket.com'}</span>
                </div>
                ...
                success: function(response) {
                    ...
                    if (response.companies && response.companies.length > 0) {
                        response.companies.forEach((company, index) => {
                            ...
                            const lng = parseFloat(company.longitude || company.lng);
                            const isValid = !isNaN(lat) && !isNaN(lng) && lat >= -90 && lat <= 90 && lng >= -180 && lng <= 180;
                            const imgSrc = company.cardAssets || '<?php echo e(asset("newAssets/img/dashboard/default_company.jpg")); ?>';
                            const img1Src = company.imgassets || '<?php echo e(asset("newAssets/img/dashboard/default_company.jpg")); ?>';
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 viewCompany pointer" companyid="${company.id}" data-name="${company.name}" data-availability="${company.companyAvailablityStatus || 'IMMEDIATE'}">
                            <div class="company-card-dashboard">
                                <div class="location-badge-dashboard">
                                    <img src="<?php echo e(asset('newAssets/img/dashboard/8.png')); ?>" style="width: 20px;height: 20px; margin-right: 4px" alt="">
                                ...
                                <div class="company-info-dashboard">
                                   <div class="company-name-dashboard" data-tooltip="${company.name}">
    <img src="${img1Src}" alt="${company.name}" class="img-fluid rounded-circle" style="width:30px;height:30px;margin-right: 8px;">
    <span class="company-name-text">${truncateName(company.name)}</span>
</div>
            ...
            success: function(response) {
                ...
                if (response.companies && response.companies.length > 0) {
                    response.companies.forEach((company, index) => {
                        ...
                        const lng = parseFloat(company.longitude || company.lng);
                        const isValid = !isNaN(lat) && !isNaN(lng) && lat >= -90 && lat <= 90 && lng >= -180 && lng <= 180;
                        const imgSrc = company.cardAssets || '<?php echo e(asset("newAssets/img/dashboard/12.avif")); ?>';
                        const img1Src = company.imgassets || '<?php echo e(asset("newAssets/img/dashboard/default_company.jpg")); ?>';
                        const availabilityClass = company.companyAvailablityStatus === 'IMMEDIATE' ? 'available-dashboard' :
                            company.companyAvailablityStatus === 'WEEKS' ? 'weeks-dashboard' :
                            company.companyAvailablityStatus === 'MONTHS' ? 'months-dashboard' :
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 viewCompany pointer" companyid="${company.id}" data-name="${company.name}" data-availability="${company.companyAvailablityStatus || 'IMMEDIATE'}">
                        <div class="company-card-dashboard">
                            ...
                            <div class="company-info-dashboard">
                                 <div class="company-name-dashboard availability-dashboard-sharp" data-tooltip="${company.name}">
    <img src="${img1Src}" alt="${company.name}" class="img-fluid rounded-circle" style="width:30px;height:30px;margin-right: 8px;">
    <span class="company-name-text">${truncateName(company.name)}</span>
</div>
                                <div class="d-flex justify-content-between" style="margin-top: 12px;">
        ...
        <div class="service-card ${selectedSubcatIds.has(String(subcategory.id)) ? 'active-subcategory' : ''}">
            ...
            <div class="service-icon">
                ${subcategory.path 
                    ...
                    : `<img class="img-sub" src="<?php echo e(asset('newAssets/img/dashboard/icons/icons2')); ?>/${imageIndex}.png" alt="${subcategory.name}">`
                }
            </div>
                        ...
                        if (card) {
                            ...
                            if (subcatId) {
                                ...
                                if (selectedSubcatIds.has(subcatId)) {
                                    ...
                                    selectedSubcatIds.clear();
                                    document.querySelectorAll('.viewSubcategory').forEach(otherCard => {
                                        const otherServiceCard = otherCard.querySelector('.service-card');
                                        otherServiceCard.classList.remove('active-subcategory');
                                    });
                                    document.querySelectorAll('.filter-tag[data-type="category"]').forEach(filterTag => {
                                        filterTag.classList.remove('active');
                                        const icon = filterTag.querySelector('i');
                                        icon.classList.remove('fa-check');
                                        icon.classList.add('fa-plus');
...
<script>
    $(document).on('click', '.bookmark-link', function(e) {
        ...
        console.log('Initial state:', {
            ...
            iconStyles: $icon.attr('style')
        });

        // Toggle UI state immediately
        if (isBookmarked) {
            console.log('Removing bookmark - changing to gray');
            ...
            console.log('Adding bookmark - changing to green');
        ...
        console.log('Making AJAX request to:', '<?php echo e(route("updateCompanyBookMarks")); ?>');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (!response) {
                    console.log('Server returned false - reverting changes');
                ...
                `;
                    ...
                    console.log('Server returned true - keeping changes');
                    // Show success toast
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('appLayouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/prax/PVT-PraxMarket-website-2025/resources/views/dashboard/index.blade.php ENDPATH**/ ?>