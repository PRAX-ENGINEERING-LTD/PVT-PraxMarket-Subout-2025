...
!function (e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).TomSelect = t() }(this, (function () {
    ...
    }, _ = e => "string" == typeof e && e.indexOf("<") > -1, I = (e, t) => {
        var i = document.createEvent("HTMLEvents")
        i.initEvent(t, !0, !1), e.dispatchEvent(i)
    }, C = (e, t) => { Object.assign(e.style, t) }, S = (e, ...t) => { var i = x(t); (e = k(e)).map((e => { i.map((t => { e.classList.add(t) })) })) }, A = (e, ...t) => { var i = x(t); (e = k(e)).map((e => { i.map((t => { e.classList.remove(t) })) })) }, x = e => {
        var t = []
        return y(e, (e => { "string" == typeof e && (e = e.trim().split(/[\11\12\14\15\40]/)), Array.isArray(e) && (t = t.concat(e)) })), t.filter(Boolean)
    }, k = e => (Array.isArray(e) || (e = [e]), e), F = (e, t, i) => {
        if (!i || i.contains(e)) for (; e && e.matches;) {
            if (e.matches(t)) return e
            e = e.parentNode
        }
    }, L = (e, t = 0) => t > 0 ? e[e.length - 1] : e[0], E = (e, t) => {
        if (!e) return -1
        t = t || e.nodeName
        for (var i = 0; e = e.previousElementSibling;)e.matches(t) && i++
        return i
    }, P = (e, t) => { y(t, ((t, i) => { null == t ? e.removeAttribute(i) : e.setAttribute(i, "" + t) })) }, T = (e, t) => { e.parentNode && e.parentNode.replaceChild(t, e) }, V = (e, t) => {
        if (null === t) return
        if ("string" == typeof t) {
            if (!t.length) return
            t = new RegExp(t, "i")
    ...
    const D = e => null == e ? null : N(e), N = e => "boolean" == typeof e ? e ? "1" : "0" : e + "", z = e => (e + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;"), R = (e, t) => {
        var i
        return function (s, n) {
            var o = this
    ...
    }, B = (e, t = !1) => { e && (e.preventDefault(), t && e.stopPropagation()) }, K = (e, t, i, s) => { e.addEventListener(t, i, s) }, M = (e, t) => !!t && (!!t[e] && 1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0)), Q = (e, t) => {
        const i = e.getAttribute("id")
        return i || (e.setAttribute("id", t), t)
    }, G = e => e.replace(/[\\"']/g, "\\$&"), U = (e, t) => { t && e.append(t) }
    function W(e, t) {
        var i = Object.assign({}, q, t), s = i.dataAttr, n = i.labelField, o = i.valueField, r = i.disabledField, l = i.optgroupField, a = i.optgroupLabelField, c = i.optgroupValueField, d = e.tagName.toLowerCase(), p = e.getAttribute("placeholder") || e.getAttribute("data-placeholder")
    ...
    class X extends (function (e) {
        return e.plugins = {}, class extends e {
            ...
            constructor(e, t) {
                ...
                var u
                if (S(r, n.wrapperClass, d, p), S(l, n.controlClass), U(r, l), S(a, n.dropdownClass, p), n.copyClassesToDropdown && S(a, d), S(c, n.dropdownContentClass), U(a, c), w(n.dropdownParent || r).appendChild(a), _(n.controlInput)) {
                    u = w(n.controlInput)
                ...
                } else n.controlInput ? (u = w(n.controlInput), this.focus_node = u) : (u = w("<input/>"), this.focus_node = l)
                ...
                if (h) {
                    ...
                    S([o, s], t)
                } (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && P(l, { multiple: "multiple" }), e.settings.placeholder && P(i, { placeholder: t.placeholder }), !e.settings.splitOn && e.settings.delimiter && (e.settings.splitOn = new RegExp("\\s*" + v(e.settings.delimiter) + "+\\s*")), t.load && t.loadThrottle && (t.load = R(t.load, t.loadThrottle)), e.control_input.type = l.type, K(s, "click", (t => {
                    const i = F(t.target, "[data-selectable]")
                    i && (e.onOptionSelect(t, i), B(t, !0))
                })), K(r, "click", (t => {
                    var s = F(t.target, "[data-ts-item]", r)
                ...
                const t = this, i = e ? W(t.input, { delimiter: t.settings.delimiter }) : t.settings
            ...
            } onMouseDown() { } onChange() { I(this.input, "input"), I(this.input, "change") } onPaste(e) {
                var t = this
                ...
                if (t.isLocked) 9 !== e.keyCode && B(e)
                    ...
                    switch (e.keyCode) {
                        case 65: if (M(j, e) && "" == t.control_input.value) return B(e), void t.selectAll()
                            break
                ...
                const i = this
                i.loading = Math.max(i.loading - 1, 0), i.lastQuery = null, i.clearActiveOption(), i.setupOptions(e, t), i.refreshOptions(i.isFocused && !i.isInputHidden), i.loading || A(i.wrapper, i.settings.loadingClass), i.trigger("load", e, t)
            } preload() {
                ...
                if ("single" !== a.settings.mode) {
                    ...
                    if ("click" === (i = t && t.type.toLowerCase()) && M("shiftKey", t) && a.activeItems.length) {
                        ...
                        B(t)
                    } else "click" === i && M(j, t) || "keydown" === i && M("shiftKey", t) ? e.classList.contains("active") ? a.removeActiveItem(e) : a.setActiveItemClass(e) : (a.clearActiveItems(), a.setActiveItemClass(e))
                    a.hideInput(), a.isFocused || a.focus()
                }
            } setActiveItemClass(e) {
                const t = this, i = t.control.querySelector(".last-active")
                i && A(i, "last-active"), S(e, "active last-active"), t.trigger("item_select", e), -1 == t.activeItems.indexOf(e) && t.activeItems.push(e)
            } removeActiveItem(e) {
                var t = this.activeItems.indexOf(e)
                this.activeItems.splice(t, 1), A(e, "active")
            } clearActiveItems() { A(this.activeItems, "active"), this.activeItems = [] } setActiveOption(e) { e !== this.activeOption && (this.clearActiveOption(), e && (this.activeOption = e, P(this.focus_node, { "aria-activedescendant": e.getAttribute("id") }), P(e, { "aria-selected": "true" }), S(e, "active"), this.scrollToOption(e))) } scrollToOption(e, t) {
                if (!e) return
            ...
            } clearActiveOption() { this.activeOption && (A(this.activeOption, "active"), P(this.activeOption, { "aria-selected": null })), this.activeOption = null, P(this.focus_node, { "aria-activedescendant": null }) } selectAll() {
                if ("single" === this.settings.mode) return
                const e = this.controlChildren()
                e.length && (this.hideInput(), this.close(), this.activeItems = e, S(e, "active"))
            } inputState() {
                var e = this
                ...
                })), w.innerHTML = "", U(w, l), f.settings.highlight && (g = w.querySelectorAll("span.highlight"), Array.prototype.forEach.call(g, (function (e) {
                    var t = e.parentNode
                    t.replaceChild(e.firstChild, e), t.normalize()
                })), m.query.length && m.tokens.length && y(m.tokens, (e => { V(w, e.regex) })))
                var _ = e => {
                ...
                } a && (-1 !== (n = i.items.indexOf(o)) && i.items.splice(n, 1, r), s = i._render("item", t), a.classList.contains("active") && S(s, "active"), T(a, s)), i.lastQuery = null
            } removeOption(e, t) {
                const i = this
                e = N(e), i.uncacheValue(e), delete i.userOptions[e], delete i.options[e], i.lastQuery = null, i.trigger("option_remove", e), i.removeItem(e, t)
            } clearOptions() {
                ...
                var t = D(e)
                return null !== t ? this.control.querySelector(`[data-value="${G(t)}"]`) : null
            } addItems(e, t) {
                ...
                if (t.is_select_tag) {
                    const e = []
                    function o(i, s, o) { return i || (i = w('<option value="' + z(s) + '">' + z(o) + "</option>")), i != n && t.input.append(i), e.push(i), i.selected = !0, i } t.input.querySelectorAll("option:checked").forEach((e => { e.selected = !1 })), 0 == t.items.length && "single" == t.settings.mode ? o(n, "", "") : t.items.forEach((n => { if (i = t.options[n], s = i[t.settings.labelField] || "", e.includes(i.$option)) { o(t.input.querySelector(`option[value="${G(n)}"]:not(:checked)`), n, s) } else i.$option = o(i.$option, n, s) }))
                } else t.input.value = t.getValue()
                t.isSetup && (e.silent || t.trigger("change", t.getValue()))
            } open() {
                var e = this
                e.isLocked || e.isOpen || "multi" === e.settings.mode && e.isFull() || (e.isOpen = !0, P(e.focus_node, { "aria-expanded": "true" }), e.refreshState(), C(e.dropdown, { visibility: "hidden", display: "block" }), e.positionDropdown(), C(e.dropdown, { visibility: "visible", display: "block" }), e.focus(), e.trigger("dropdown_open", e.dropdown))
            } close(e = !0) {
                var t = this, i = t.isOpen
                e && (t.setTextboxValue(), "single" === t.settings.mode && t.items.length && t.hideInput()), t.isOpen = !1, P(t.focus_node, { "aria-expanded": "false" }), C(t.dropdown, { display: "none" }), t.settings.hideSelected && t.clearActiveOption(), t.refreshState(), i && t.trigger("dropdown_close", t.dropdown)
            } positionDropdown() {
                if ("body" === this.settings.dropdownParent) {
                    ...
                    C(this.dropdown, { width: t.width + "px", top: i + "px", left: s + "px" })
                }
            } clear(e) {
                var t = this
                if (t.items.length) {
                ...
                var i, s, n = this
                n.rtl && (e *= -1), n.inputValue().length || (M(j, t) || M("shiftKey", t) ? (s = (i = n.getLastActive(e)) ? i.classList.contains("active") ? n.getAdjacent(i, e, "item") : i : e > 0 ? n.control_input.nextElementSibling : n.control_input.previousElementSibling) && (s.classList.contains("active") && n.removeActiveItem(i), n.setActiveItemClass(s)) : n.moveCaret(e))
                ...
                e.trigger("destroy"), e.off(), e.wrapper.remove(), e.dropdown.remove(), e.input.innerHTML = t.innerHTML, e.input.tabIndex = t.tabIndex, A(e.input, "tomselected", "ts-hidden-accessible"), e._destroy(), delete e.input.tomselect
    ...
    } return X.define("change_listener", (function () { K(this.input, "change", (() => { this.sync() })) })), X.define("checkbox_options", (function () {
    ...
    })), X.define("clear_button", (function (e) {
        ...
        t.on("initialize", (() => {
            ...
            s && s.addEventListener("click", (e => { B(e, !0), t.close() })), t.dropdown.insertBefore(e, t.dropdown.firstChild)
        }))
    })), X.define("caret_position", (function () {
        var e = this
    ...
    })), X.define("dropdown_input", (function () {
        var e = this
        e.settings.shouldOpen = !0, e.hook("before", "setup", (() => {
            e.focus_node = e.control, S(e.control_input, "dropdown-input")
            const t = w('<div class="dropdown-input-wrap">')
            t.append(e.control_input), e.dropdown.insertBefore(t, e.dropdown.firstChild)
        })), e.on("initialize", (() => {
            e.control_input.addEventListener("keydown", (t => {
                switch (t.keyCode) {
                    case 27: return e.isOpen && (B(t, !0), e.close()), void e.clearActiveItems()
            ...
            const t = e.onBlur
            e.hook("instead", "onBlur", (i => { if (!i || i.relatedTarget != e.control_input) return t.call(e) })), K(e.control_input, "blur", (() => e.onBlur())), e.hook("before", "close", (() => { e.isOpen && e.focus_node.focus() }))
        }))
    })), X.define("input_autogrow", (function () {
        var e = this
        e.on("initialize", (() => {
    ...
    })), X.define("no_backspace_delete", (function () {
        var e = this, t = e.deleteSelection
        this.hook("instead", "deleteSelection", (i => !!e.activeItems.length && t.call(e, i)))
    })), X.define("no_active_items", (function () { this.hook("instead", "setActiveItem", (() => { })), this.hook("instead", "selectAll", (() => { })) })), X.define("optgroup_columns", (function () {
        var e = this, t = e.onKeyDown
        e.hook("instead", "onKeyDown", (i => {
            var s, n, o, r
            if (!e.isOpen || 37 !== i.keyCode && 39 !== i.keyCode) return t.call(e, i)
            r = F(e.activeOption, "[data-group]"), s = E(e.activeOption, "[data-selectable]"), r && (r = 37 === i.keyCode ? r.previousSibling : r.nextSibling) && (n = (o = r.querySelectorAll("[data-selectable]"))[Math.min(o.length - 1, s)]) && e.setActiveOption(n)
        }))
        ...
        if (t.append) {
            ...
            i.hook("after", "setupTemplates", (() => {
                ...
                i.settings.render.item = (t, n) => {
                    ...
                    return o.appendChild(r), K(r, "mousedown", (e => { B(e, !0) })), K(r, "click", (e => {
                        if (B(e, !0), !i.isLocked) {
    ...
    })), X.define("restore_on_backspace", (function (e) {
    ...
    })), X.define("virtual_scroll", (function () {
        ...
        function l(t) { return !("number" == typeof e.settings.maxOptions && n.children.length >= e.settings.maxOptions) && !(!(t in o) || !o[t]) } e.settings.sortField = [{ field: "$order" }, { field: "$score" }], e.setNextUrl = function (e, t) { o[e] = t }, e.getUrl = function (t) {
            ...
            const t = e.lastValue
            var i
            l(t) ? (i = e.render("loading_more", { query: t })) && i.setAttribute("data-selectable", "") : t in o && !n.querySelector(".no-results") && (i = e.render("no_more_results", { query: t })), i && (S(i, e.settings.optionClass), n.append(i))
