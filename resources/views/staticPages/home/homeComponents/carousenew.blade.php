...
<head>
    ...
    <style>
        .hero-section-2 {
            background-image: url("{{ asset('newAssets/img/home/ypraxbg.png') }}");
                ...
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <h5 class="why-prax-v2">
                        <button class="btn-why-one" style="font-family: 'Manrope-Medium';">
                            <img src="{{ asset('newAssets/img/home/icons/zap.png') }}" style="margin-right: 10px; margin-top: -3px; width:16px" loading="lazy">Why PRAX Market?
                        </button>
                    </h5>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="carousel-feature-image">
                                    <img src="{{ asset('newAssets/img/home/card/1.png') }}" alt="Seamless Connections" loading="lazy" />
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="carousel-feature-image">
                                    <img src="{{ asset('newAssets/img/home/card/2.png') }}" alt="One-Stop Solution" loading="lazy" />
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="carousel-feature-image">
                                    <img src="{{ asset('newAssets/img/home/card/3.png') }}" alt="Boost Your Visibility" loading="lazy" />
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="carousel-feature-image">
                                    <img src="{{ asset('newAssets/img/home/card/4.png') }}" alt="Save Time & Resources" loading="lazy" />
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="carousel-feature-image">
                                    <img src="{{ asset('newAssets/img/home/card/5.png') }}" alt="Hyperlocal & Global Reach" loading="lazy"/>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="carousel-feature-image">
                                    <img src="{{ asset('newAssets/img/home/card/6.png') }}" alt="Trust & Security" loading="lazy" />
                                </div>
