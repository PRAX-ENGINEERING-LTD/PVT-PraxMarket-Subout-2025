...
<body>
    ...
    @include('staticPages.home.homeComponents.heromarquee')


    @include('staticPages.home.homeComponents.carousenew')
    @include('staticPages.home.homeComponents.cardmarquee')
    @include('staticPages.home.homeComponents.cardsection')
    @include('staticPages.home.homeComponents.hometimeline')
    @include('staticPages.home.homeComponents.competitiveEdge')
    @include('staticPages.home.homeComponents.partners')
    @include('staticPages.addedContents.countnumber')
    @include('staticPages.addedContents.faq')
    @include('staticPages.addedContents.marquee')
    ...
    <section  class="platform-section position-relative mt-5"  style="position: relative;overflow: hidden;">
        <h5 class="why-prax" style="text-align:center;margin-bottom:20px">
            <img src="{{ asset('newAssets/img/home/icons/zap.png') }}" style="width: 17px;" alt="icon" />
        ...
        <div class="container-fluid home-content" style="padding:40px">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="platform-feature-card">
                        <div class="platform-feature-image">
                            <img src="{{ asset('newAssets/img/home/card/1.png') }}" alt="Seamless Connections" />
                        </div>
                ...
                <div class="col-md-4">
                    <div class="platform-feature-card">
                        <div class="platform-feature-image">
                            <img src="{{ asset('newAssets/img/home/card/2.png') }}" alt="One-Stop Solution" />
                        </div>
                ...
                <div class="col-md-4">
                    <div class="platform-feature-card">
                        <div class="platform-feature-image">
                            <img src="{{ asset('newAssets/img/home/card/3.png') }}" alt="Boost Your Visibility" />
                        </div>
            ...
            <div class="row g-4 py-5">
                <div class="col-md-4">
                    <div class="platform-feature-card">
                        <div class="platform-feature-image">
                            <img src="{{ asset('newAssets/img/home/card/4.png') }}" alt="Seamless Connections" />
                        </div>
                ...
                <div class="col-md-4">
                    <div class="platform-feature-card">
                        <div class="platform-feature-image">
                            <img src="{{ asset('newAssets/img/home/card/5.png') }}" alt="One-Stop Solution" />
                        </div>
                ...
                <div class="col-md-4">
                    <div class="platform-feature-card">
                        <div class="platform-feature-image">
                            <img src="{{ asset('newAssets/img/home/card/6.png') }}" alt="Boost Your Visibility" />
                        </div>
