...
<body>
  <div class="container-fluid p-0 hero-marquee">
    ...
    <video class="background-video" autoplay loop muted>
      <source src="{{ asset('newAssets/img/homecomponents/heromarquee/lightrays1.mp4') }}" type="video/mp4" preload="none" loading="lazy">
    ...
    <div class="marquee-container-home">
      ...
      <div class="center-item-container">
        <div class="center-item">
          <img src="{{ asset('newAssets/img/homecomponents/heromarquee/prax_logo2.png') }}" alt="Center Item">
        </div>
      </div>
      ...
      <div class="marquee-left-container">
        <div class="marquee-track marquee-left">
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/1.png') }}" alt="CNC Machining" loading="lazy" />
            <div class="marquee-item-label">CNC Machining Services</div>
          </div>
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/2.png') }}" alt="3D Printing" loading="lazy">
            <div class="marquee-item-label">Sheet Metal Fabrication</div>
          </div>
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/3.png') }}" alt="Surface Treatment" loading="lazy">
            <div class="marquee-item-label">Surface Treatment & Finishing</div>
          </div>
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/4.png') }}" alt="Engineering SME" loading="lazy">
            <div class="marquee-item-label">Metrology & Inspection Services</div>
          </div>
          
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/5.png') }}" alt="3D Printing" loading="lazy">
            <div class="marquee-item-label">Material Suppliers</div>
          </div>

          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/6.png') }}" alt="Surface Treatment" loading="lazy">
      ...
      <div class="marquee-right-container">
        ...
        <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/7.png') }}" alt="CNC Machining" loading="lazy">
            <div class="marquee-item-label">Pricision Grinding Services</div>
          </div>
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/8.png') }}" alt="3D Printing" loading="lazy">
            <div class="marquee-item-label">Logistics & Supply Chain Support    
            </div>
          </div>
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/9.png') }}" alt="Surface Treatment" loading="lazy">
            <div class="marquee-item-label">3D Printing Services</div>
          </div>
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/10.png') }}" alt="Engineering SME" loading="lazy">
            <div class="marquee-item-label">Technology & R&D</div>
          </div>
         
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/11.png') }}" alt="CNC Machining" loading="lazy">
            <div class="marquee-item-label">Machine & Equipment Supliers</div>
          </div>
          <div class="marquee-item-home">
            <img src="{{ asset('newAssets/img/homecomponents/heromarquee/hero/12.png') }}" alt="Surface Treatment" loading="lazy">
      ...
      <div class="container logo-group">
        ...
        <div class="marquee-wrapper">
          <div class="logo-container" id="logoContainer">
             Original logos -->
            <!-- <img class="logo-item" src="{{ asset('newAssets/img/homecomponents/heromarquee/logo-group1.png') }}" alt="Partner Logo">
          </div>
        </div>
      </div>
    </div>  -->
