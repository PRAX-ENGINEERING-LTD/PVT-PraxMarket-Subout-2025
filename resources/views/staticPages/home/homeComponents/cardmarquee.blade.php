...
<head>
    ...
    <style>
        ...
        .explore-bg {
            background-image: url("{{ asset('newAssets/img/home/explore1.png') }}");
    ...
    <div class="container-fluid explore-bg">
        <div class="text-center">
            <button class="btn-service-marquee" style="font-family: 'Manrope-Medium';">
                <img src="{{ asset('newAssets/img/home/icons/search.png') }}" style="margin-right: 10px; margin-top: -3px; width:16px" loading="lazy">Explore Services
            </button>
        </div>
        ...
        <div class="services-container">
            <div class="services-track" id="services-track">
                ...
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/1.png') }}" alt="CNC Machining Services">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D" loading="lazy">90+</div>
                ...
                <!-- Service 2 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/2.png') }}" alt="Sheet Metal Fabrication">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D" loading="lazy">50+</div>
                ...
                <!-- Service 3 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/3.png') }}" alt="Surface Treatment & Finishing">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">100+</div>
                ...
                <!-- Service 4 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/4.png') }}" alt="Metrology & Inspection Services">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">80+</div>
                ...
                <!-- Service 5 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/5.png') }}" alt="Materials Suppliers">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">70+</div>
                ...
                <!-- Service 6 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/6.png') }}" alt="CNC Cutting Tool Suppliers">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">90+</div>
                ...
                <!-- Service 7 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/7.png') }}" alt="Precision Grinding Services">
                    <div class="service-badge"><img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">50+</div>
                ...
                <!-- Service 8 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/8.png') }}" alt="Logistics & Supply Chain Support">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">100+</div>
                ...
                <!-- Service 9 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/9.png') }}" alt="3D Printing Services">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">70+</div>
                ...
                <!-- Service 10 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/10.png') }}" alt="Technology & R&D">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">80+</div>
                ...
                <!-- Service 11 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/11.png') }}" alt="Machine & Equipment Suppliers">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">90+</div>
                ...
                <!-- Service 12 -->
                <div class="service-card">
                    <img class="service-card-img" src="{{ asset('newAssets/img/homecomponents/Services/Images/img1/12.png') }}" alt="Finance & Business Services">
                    <div class="service-badge"> <img class="brief-case-img" src="{{ asset('newAssets/img/homecomponents/Services/Icons/briefcase-business.png') }}" alt="R&D">90+</div>
