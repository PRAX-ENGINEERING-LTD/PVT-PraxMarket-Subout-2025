    ...
    <div class="container timeline-bg">
        <div class="text-center mt-5">
            <button class="btn-service-timeline" style="font-family: 'Manrope-Medium';">
                <img src="{{ asset('newAssets/img/homecomponents/timeline/advantages1.png') }}" style="margin-right: 10px; margin-top: -3px; width:16px" loading="lazy">Advantage
            </button>
        </div>
        ...
        <div class="timeline">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5" style="text-align: center;">
                        <div class="timeline-image-container" data-aos="fade-right">
                            <img src="{{ asset('newAssets/img/homecomponents/timeline/1.png') }}" alt="Central Hub Illustration" loading="lazy" class="timeline-image">
                        </div>
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="timeline-content" data-aos="fade-left">
                            <div class="timeline-card">
                                <h3><img src="{{ asset('newAssets/img/homecomponents/timeline/7.png') }}" loading="lazy" class="timeline-inside-img" alt="">Find What You Need</h3>
                                <ul class="time-ul">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="timeline-content" data-aos="fade-right">
                            <div class="timeline-card">
                                <h3><img src="{{ asset('newAssets/img/homecomponents/timeline/8.png') }}" loading="lazy" class="timeline-inside-img" alt="">Choose the Right Partner</h3>
                                <ul class="time-ul">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="timeline-image-container" data-aos="fade-left">
                            <img src="{{ asset('newAssets/img/homecomponents/timeline/2.png') }}" loading="lazy" alt="Premium Profiles Illustration" class="timeline-image">
                        </div>
                        <!-- <div class="timeline-heading">
            ...
            <div class="timeline-item" id="item3" data-position="2">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="timeline-image-container" data-aos="fade-right">
                            <img src="{{ asset('newAssets/img/homecomponents/timeline/3.png') }}" loading="lazy" alt="Jobs and Projects Illustration" class="timeline-image">
                        </div>
                        <!-- <div class="timeline-heading">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="timeline-content" data-aos="fade-left">
                            <div class="timeline-card">
                                <h3><img src="{{ asset('newAssets/img/homecomponents/timeline/9.png') }}" loading="lazy" class="timeline-inside-img" alt="">Build Long-Term Relationships</h3>
                                <ul class="time-ul">
            ...
            <div class="timeline-item" id="item4" data-position="3">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="timeline-content" data-aos="fade-right">
                            <div class="timeline-card">
                                <h3><img src="{{ asset('newAssets/img/homecomponents/timeline/10.png') }}" loading="lazy" class="timeline-inside-img" alt="">Stay Active & Visible</h3>
                                <ul class="time-ul">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="timeline-image-container" data-aos="fade-left">
                            <img src="{{ asset('newAssets/img/homecomponents/timeline/4.png') }}" loading="lazy" alt="R&D Companies Illustration" class="timeline-image">
                        </div>
                        <!-- <div class="timeline-heading">
            ...
            <div class="timeline-item" id="item3" data-position="2">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="timeline-image-container" data-aos="fade-right">
                            <img src="{{ asset('newAssets/img/homecomponents/timeline/5.png') }}" loading="lazy" alt="Jobs and Projects Illustration" class="timeline-image">
                        </div>
                        <!-- <div class="timeline-heading">
                            <span class="title">3. Display Your Jobs and Projects</span>
                        </div> -->
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="timeline-content" data-aos="fade-left">
                            <div class="timeline-card">
                                <h3><img src="{{ asset('newAssets/img/homecomponents/timeline/11.png') }}" loading="lazy" class="timeline-inside-img" alt="">Grow Your Network</h3>
                                <ul class="time-ul">
            ...
            <div class="timeline-item" id="item4" data-position="3">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="timeline-content" data-aos="fade-right">
                            <div class="timeline-card">
                                <h3><img src="{{ asset('newAssets/img/homecomponents/timeline/12.png') }}" loading="lazy" class="timeline-inside-img" alt="">Manage Everything in One Place</h3>
                                <ul class="time-ul">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="timeline-image-container" data-aos="fade-left">
                            <img src="{{ asset('newAssets/img/homecomponents/timeline/6.png') }}" loading="lazy" alt="R&D Companies Illustration" class="timeline-image">
                        </div>
                        <!-- <div class="timeline-heading">
                            <span class="title">4. Supporting R&D <br />Companies</span>
                        </div> -->
