...
<head>
    ...
    <style>
        .footer-section {
            background-image: url("{{ asset('newAssets/img/footer/footer-bg.png') }}");
...
<body>
    ...
    <footer class="footer-section">
            ...
            <div class="row first-col-res" style="position: relative;overflow:hidden;">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12  col-m-2 mobile-none">
                    ...
                    <div class="contact-item">
                        ...
                        <a href="tel:00447961008" style="white-space: nowrap;" class="footer-link-new"> <img src="{{ asset('newAssets/img/footer/phone.png') }}" style="width: 20px;margin-right: 8px;"> 0044 7961008744</a>
                    </div>
                    <div class="contact-item">
                        <div class="contact-icon">

                        </div>
                        <a href="tel:00441480759133" style="white-space: nowrap;" class="footer-link-new"> <img src="{{ asset('newAssets/img/footer/call.png') }}" style="width: 20px;margin-right: 8px;">0044 1480759133</a>
                    </div>
                    <div class="contact-item">
                        <div class="contact-icon">

                        </div>
                        <a href="mailto:info@praxmarket.com" style="white-space: nowrap;" class="footer-link-new"> <img src="{{ asset('newAssets/img/footer/mail.png') }}" style="width: 20px;margin-right: 8px;">info@praxmarket.com</a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-m-3 nav-res-3">
                    ...
                    <a href="#" class="footer-link-home">Home</a>
                    <a href="#" class="footer-link-home">About us</a>
                    <a href="#" class="footer-link-home">How it works</a>
                    <a href="#" class="footer-link-home">Pricing</a>
                    <a href="#" class="footer-link-home">Contact us</a>
                </div>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-m-4">
                    ...
                    <a href="#" target="_blank" class="footer-link footer-link-res">Privacy Policy</a>
                    <a href="#" target="_blank" class="footer-link footer-link-res">Terms & Conditions</a>
                    <a href="#" target="_blank" class="footer-link  footer-link-res">Usage Policy</a>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="social-media">
                        ...
                        <div class="social-icons-mobile" style="display: flex;">
                            <div class="bg-social">
                                <a href="#"> <img src="{{ asset('newAssets/img/footer/1.png') }}" class="footer-icon-social" style="width: 20px;margin-left:10px;margin-right:10px"></a>
                            </div>
                            <div class="bg-social">
                                <a href="#"><img src="{{ asset('newAssets/img/footer/2.png') }}" class="footer-icon-social" style="width: 20px;margin-left:10px;margin-right:10px"></a>
                            </div>
                            <div class="bg-social">
                                <a href="#"><img src="{{ asset('newAssets/img/footer/3.png') }}" class="footer-icon-social" style="width: 20px;margin-left:10px;margin-right:10px"></a>
                            </div>

                            <div class="bg-social">
                                <a href="#"><img src="{{ asset('newAssets/img/footer/4.png') }}" class="footer-icon-social" style="width: 20px;margin-left:10px;margin-right:10px"></a>
                            </div>
        ...
        <!-- <div id="scrollToTopBtn" class="scroll-to-top" aria-label="Scroll to top">
            <img src="{{ asset('newAssets/img/home/arrow-up.png') }}" style="width: 26px;" alt="Facebook">
        </div> -->
