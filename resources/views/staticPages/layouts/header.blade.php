...
<body>
    <header class="header">
        <div class="logo">
            <a href="#"> <img src="{{ asset('newAssets/img/header/prax_logo1.png') }}" alt="Prax Market Logo"></a>
        ...
        <!-- Desktop Navigation -->
        <nav class="nav-links">
            @if (!request()->routeIs('home.showHomePage'))
            <a href="#">Home</a>
            @endif

            @if (!request()->routeIs('home.showAboutUsPage'))
            <a href="#">About us</a>
            @endif

            @if (!request()->routeIs('home.showHowItWorksPage'))
            <a href="#">How it works</a>
            @endif

            @if (!request()->routeIs('home.showPricingPage'))
            <a href="#">Pricing</a>
            @endif

            @if (!request()->routeIs('home.showContactUsPage'))
            <a href="#">Contact us</a>
            @endif
        </nav>
        ...
        <div class="auth-buttons">
            ...
            @if (Auth::check())
            <a href="{{ route('network.index') }}" class="header-btn btn-signup" id="desktopDashBtn">Go To Console</a>
            @else
            @if (!request()->routeIs('login'))
            <a href="{{ route('login') }}" class="header-btn btn-login" id="desktopLoginBtn">SIGN IN</a>
            @endif
            @if (!request()->routeIs('signup'))

            <a href="#" class="header-btn btn-signup" id="desktopSignupBtn">SIGN UP</a>
            @endif
            @endif
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-auth-buttons">
            ...
            @if (Auth::check())
            <a href="{{ route('network.index') }}" class="header-btn btn-signup" id="mobileDashBtn">Go To Console</a>
            @else
            @if (!request()->routeIs('login'))

            <a href="{{ route('login') }}" class="header-btn btn-login" id="mobileLoginBtn">SIGN IN</a>

            @endif
            @if (!request()->routeIs('signup'))

            <a href="#" class="header-btn btn-signup" id="mobileSignupBtn">SIGN UP</a>
            @endif
            @endif
