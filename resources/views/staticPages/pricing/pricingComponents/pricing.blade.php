...
<head>
    ...
    <style>
        ...
        .pricing-bg {
            background-image: url("{{ asset('newAssets/img/pricing/bg1.png') }}");
        ...
        .pricing-card {
            ...
            background-image: url("{{ asset('newAssets/img/pricing/bg2.png') }}");
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            border-radius: 16px;
    ...
    <div class="container-fluid pricing-bg">
        <div class="text-center">
            <button class="btn-service-pricing" style="font-family: 'Manrope-Medium';">
                <img src="{{ asset('newAssets/img/pricing/crown.png') }}" style="margin-right: 10px; margin-top: -3px; width:16px" loading="lazy">Pricing
            </button>
        </div>
            ...
            <div class="col-md-6 pricing-section">
                <div class="pricing-card position-relative">
                    ...
                    <a href="#" class="get-started-btn premium-btn particle-effect">
                        ...
                        <img src="{{ asset('newAssets/img/pricing/1.png') }}" style="margin-right: 12px; width:18px" loading="lazy">
                    ...
                    <div class="pricing-features">
                        ...
                        <div class="feature-item">
                            <span class="feature-check"><img src="{{ asset('newAssets/img/pricing/tick.png') }}" style="margin-right:2px; margin-top: -3px; width:15px" loading="lazy"></span>
        ...
        <div class="container-fluid count-bg-one">
            ...
            <div class="numbers-section-join">
                <div class="testimonials-btn2-one">
                    <span class="testi"><span><img src="{{ asset('newAssets/img/home/icons/join.png') }}" loading="lazy" style="width: 19px;margin-top: -2px;"></span> <span style="margin-left: 5px;">Join PRAX Market</span></span>
                </div>
                <div style="text-align: center;">
                    ...
                    <div class="button-join">
                        <button>Join Now <img src="{{ asset('newAssets/img/homecomponents/arrow.png') }}" style="width:16px;" loading="lazy" alt="" class="img-join"></button>
                    </div>
                </div>
            </div>
        </div>
