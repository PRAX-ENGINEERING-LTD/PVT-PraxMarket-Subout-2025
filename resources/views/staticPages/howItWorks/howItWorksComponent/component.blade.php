...
<head>
    ...
    <style>
        ...
        .unlock-bg {
            background-image: url("{{ asset('newAssets/img/howitworks/bg.png') }}");
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            padding: 120px;
        ...
        @media (max-width: 425px) {
            ...
            .video-container-frame{
                background-image: url("{{ asset('newAssets/img/marquee/bg1.png') }}") !important;
            background-size: cover;
        ...
        <div class="row align-items-center">
                ...
                <div class="about-content">
                    <div class="text-start mb-3 how-hero-button">
                        <button class="btn-service-one" style="font-family: 'Manrope-Medium';">
                            <img src="{{ asset('newAssets/img/homecomponents/circle-help.png') }}" loading="lazy" style="margin-right: 10px; margin-top: -3px; width:16px">How it works
                        </button>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="howit-hero-img">
                    <img src="{{ asset('newAssets/img/howitworks/hero1.png') }}" loading="lazy" alt="" class="about-hero-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="unlock-bg">
        ...
        <div class="video-container-frame">
            <video autoplay muted loop id="myVideo">
                <source src="{{ asset('newAssets/img/howitworks/Video.mp4') }}" loading="lazy" preload="none" type="video/mp4">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="feature-card-how">
                    ...
                    <div class="card-image-how">
                        <img src="{{ asset('newAssets/img/howitworks/1.png') }}" loading="lazy" alt="" class="">
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="feature-card-how">
                    ...
                    <div class="card-image-how">
                        <img src="{{ asset('newAssets/img/howitworks/2.png') }}" loading="lazy" alt="" class="">
                    </div>
                    <div class="description-how">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="feature-card-how">
                    ...
                    <div class="card-image-how">
                        <img src="{{ asset('newAssets/img/howitworks/3.png') }}" loading="lazy" alt="" class="">
                    </div>
                    <div class="description-how">
        ...
        <div class="row g-4 py-5">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="feature-card-how">
                    ...
                    <div class="card-image-how">
                        <img src="{{ asset('newAssets/img/howitworks/4.png') }}" loading="lazy" alt="" class="">
                    </div>
                    <div class="description-how">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="feature-card-how">
                    ...
                    <div class="card-image-how">
                        <img src="{{ asset('newAssets/img/howitworks/5.png') }}" loading="lazy" alt="" class="">
                    </div>
                    <div class="description-how">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="feature-card-how">
                    ...
                    <div class="card-image-how">
                        <img src="{{ asset('newAssets/img/howitworks/6.png') }}" loading="lazy" alt="" class="">
                    </div>
                    <div class="description-how">
