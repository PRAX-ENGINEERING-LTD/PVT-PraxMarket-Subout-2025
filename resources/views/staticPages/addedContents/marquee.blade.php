...
;
    ...
    will-change: opacity, transform;
        ...
        .marquee-item {
            ...
            margin: 0;
            padding: 24px;
            background-image: url("{{ asset('newAssets/img/marquee/bg2.png') }}");
            background-size: cover;
...
<body>
    ...
    <div class="container-fluid marquee-bg">
        ...
        <div class="testimonials-btn">
            <img src="{{ asset('newAssets/img/home/testi.png') }}" loading="lazy" style="width: 16px;margin-top: -2px;"><span class="testi">Testimonials</span></img>
        </div>
            ...
            <div class="marquee">
                <div class="marquee-item">
                    ...
                    <div class="img-with-p">
                        ...
                        <img src="{{ asset('newAssets/img/marquee/star.png') }}" loading="lazy" style="width: 19px;"></img>
                        <img src="{{ asset('newAssets/img/marquee/star.png') }}" loading="lazy" style="width: 19px;"></img>
                        <img src="{{ asset('newAssets/img/marquee/star.png') }}" loading="lazy" style="width: 19px;"></img>
                    </div>
