...
<body>
    <div class="container-fluid contact-container">
        <div class="row">
            ...
            <div class="col-md-6 contact-left">
                ...
                <img src="{{ asset('newAssets/img/contact/1.png') }}" alt="" style="width: 100%; object-fit: cover; max-width: 440px;" loading="lazy" class="img-fluid">
            </div>
            ...
            <div class="col-md-6">
                <div class="contact-form">
                    <h2>Contact Us</h2>
                    <form id="contactForm" method="POST" action="{{ route('submitRequest') }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-illustration">
                    <img src="{{ asset('newAssets/img/contact/2.png') }}"  loading="lazy" alt="Thank you illustration">
                </div>
    ...
    <div id="errorModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-illustration">
                    <img src="{{ asset('newAssets/img/contact/3.png') }}" loading="lazy" alt="Error illustration">
                </div>
